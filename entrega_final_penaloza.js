...
//Se realizan promesas de stock negativo
let sin_stock_comp={}
let stock_negativo=new Promise(function(resolve,reject){
    if (comp_1.stock_inicial_comp>0&&comp_2.stock_inicial_comp>0&&comp_3.stock_inicial_comp>0){
        ...
        reject("No hay stock suficiente de componentes para fabricar");
    }
})

stock_negativo
    .then(function(sin_stock_comp){
        console.log("OK");
    })
